(function () {
  ...
  if ("IntersectionObserver" in window) {
    ...
    var revealTargets = document.querySelectorAll(
      ".section-head, .card, .step, .why-media, .why-copy, .results-feature, .gallery figure, .plan, .review, .areas-copy, .areas-list, .contact-copy, .quote-form"
    );
  ...
  var BUSINESS_EMAIL = "hello@bbpremiercleaning.com";
